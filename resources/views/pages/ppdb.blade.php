                ...
                <div class="mt-4 gap-2 flex flex-col">
                    ...
                    <section class="grid grid-cols-2 gap-x-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="uk_baju" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5" />
                        </div>
                    </section>
                </div>
            </div>
